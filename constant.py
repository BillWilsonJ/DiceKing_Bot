...
# remind me units
SECONDS_UNITS = ['s','second','seconds']
MINUTES_UNITS = ['m','minute','minutes']
HOURS_UNITS = ['h','hour','hours']
DAYS_UNITS = ['d','day','days']
WEEKS_UNITS = ['w','week','weeks']
FORTNITES_UNITS = ['f','fortnite','fortnites']
MONTHS_UNITS = ['mo','month','months']
YEARS_UNITS = ['y','year','years']
TIME_UNITS = SECONDS_UNITS + MINUTES_UNITS + HOURS_UNITS + DAYS_UNITS + WEEKS_UNITS + FORTNITES_UNITS + MONTHS_UNITS + YEARS_UNITS

MONTH_LIST = ['jan','january','feb','february','mar','march','apr','april','may','jun','june','jul','july','aug','august','sept','september','oct','october','nov','november','dec','december']
